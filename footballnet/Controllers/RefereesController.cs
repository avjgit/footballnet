...
namespace footballnet.Controllers
{
    public class RefereesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Firstname,Lastname,Games,Penalties,AvgPenaltiesPerGame")] Referee referee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Firstname,Lastname,Games,Penalties,AvgPenaltiesPerGame")] Referee referee)
        {
            if (ModelState.IsValid)
            {
